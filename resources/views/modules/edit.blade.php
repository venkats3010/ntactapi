                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-sm-12 col-md-12 text-end">
                                    <button class="btn btn-primary btn-block mt-2 btn-submit updateModule"><span>{{ __('Update') }}</span></button>
                                </div>
                            </div>
                        </div>
...
<script>
        $('.updateModule').on('click', function() {
            ...
            $('.updateModule').prop('disabled', true).html('Please Wait...');

            $.ajax({
                    url: "{{ url('/modules/update') }}",
                    type: 'post',
                    data: {  _token: "{{ csrf_token() }}", rowid:rowid, title:title, slug:slug, :content:content, status:status, meta_title:meta_title, meta_description:meta_description  },
                    dataType: 'json',
                    success: function(res) {
						...
						if (res.status == '200') {
							...
							$('.updateModule').prop('disabled', false);
							$('.updateModule').html('Save');
						}
