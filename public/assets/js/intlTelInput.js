...
!(function (a) {
        ...
        (e.prototype = {
            ...
            _f: function () {
                ...
                c.appendTo(this.k),
                    ...
                    this.b.separateDialCode && (this.t = a("<div>", { class: "selected-dial-code" }).appendTo(c)),
                    this.b.allowDropdown
                        ? (c.attr("tabindex", "0"),
                          a("<div>", { class: "iti-arrow" }).appendTo(c),
                          (this.m = a("<ul>", { class: "country-list hide" })),
                          this.preferredCountries.length && (this._g(this.preferredCountries, "preferred"), a("<li>", { class: "divider" }).appendTo(this.m)),
                          this._g(this.p, ""),
                          (this.o = this.m.children(".country")),
                          this.b.dropdownContainer ? (this.dropdown = a("<div>", { class: "intl-tel-input iti-container" }).append(this.m)) : this.m.appendTo(this.k))
                        : (this.o = a()),
                    this.b.hiddenInput && (this.hiddenInput = a("<input>", { type: "hidden", name: this.b.hiddenInput }).insertBefore(this.a));
            },
            _g: function (a, b) {
            ...
            _h: function () {
                var a = this.a.val();
                this._af(a) && (!this._isRegionlessNanp(a) || (this.b.nationalMode && !this.b.initialCountry))
                    ? this._v(a)
                    : "auto" !== this.b.initialCountry &&
                      (this.b.initialCountry ? this._z(this.b.initialCountry.toLowerCase()) : ((this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2), a || this._z(this.j)),
            ...
            _z: function (a) {
                ...
                var c = a ? this.s.dialCode : "Unknown";
    ...
    for (
        var k = [
                ...
                ["Curaçao", "cw", "599", 0],
                ["Cyprus ", "cy", "357"],
                ["Czech Republic (Ceská republika)", "cz", "420"],
                ["Denmark (Danmark)", "dk", "45"],
                ["Djibouti", "dj", "253"],
                ["Dominica", "dm", "1767"],
                ["Dominican Republic (Republica Dominicana)", "do", "1", 2, ["809", "829", "849"]],
                ["Ecuador", "ec", "593"],
                ["Egypt ", "eg", "20"],
                ["El Salvador", "sv", "503"],
                ...
                ["Guatemala", "gt", "502"],
                ["Guernsey", "gg", "44", 1],
                ["Guinea (Guinee)", "gn", "224"],
                ["Guinea-Bissau (Guine Bissau)", "gw", "245"],
                ["Guyana", "gy", "592"],
                ["Haiti", "ht", "509"],
                ["Honduras", "hn", "504"],
                ["Hong Kong ", "hk", "852"],
                ["Hungary (Magyarország)", "hu", "36"],
                ["Iceland (Island)", "is", "354"],
                ["India ", "in", "91"],
                ["Indonesia", "id", "62"],
                ["Iran ", "ir", "98"],
                ["Iraq ", "iq", "964"],
