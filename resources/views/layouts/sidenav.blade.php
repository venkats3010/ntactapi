  ...
  <div id="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="dash-navbar" id="sidebar_menu">
				...
				<li class="dash-item {{ request()->is('*employees*') ? ' active' : '' }}">
                    <a href="{{ url('employees') }}" class="dash-link "><span class="dash-micon"><i class="fa fa-user"></i></span><span class="dash-mtext">{{ __('Employees') }}</span></a>
                </li>

                <li class="dash-item {{ request()->is('*jobs*') ? ' active' : '' }}">
                    <a href="{{ url('jobs') }}" class="dash-link "><span class="dash-micon"><i class="mdi mdi-wallet-travel"></i></span><span class="dash-mtext">{{ __('Jobs') }}</span></a>
                </li>

                <li class="dash-item {{ request()->is('*costcodes*') ? ' active' : '' }}">
                    <a href="{{ url('costcodes') }}" class="dash-link "><span class="dash-micon"><i class="mdi mdi-cash"></i></span><span class="dash-mtext">{{ __('cost center') }}</span></a>
                </li>

                <li class="dash-item {{ request()->is('*time-sheet*') ? ' active' : '' }}">
                    <a href="{{ url('time-sheet') }}" class="dash-link "><span class="dash-micon"><i class="ti ti-clock"></i></span><span class="dash-mtext">{{ __('Time Sheets') }}</span></a>
                </li>

                <li class="dash-item {{ request()->is('*payroll*') ? ' active' : '' }}">
                    <a href="{{ url('payroll') }}" class="dash-link "><span class="dash-micon"><i class="mdi mdi-calculator"></i></span><span class="dash-mtext">{{ __('Payroll') }}</span></a>
                </li>

				        <li class="dash-item {{ request()->is('*users*') ? ' active' : '' }}">
                    <a href="{{ url('users') }}" class="dash-link "><span class="dash-micon"><i class="ti ti-user"></i></span><span class="dash-mtext">{{ __('Users') }}</span></a>
                </li>
                <li class="dash-item {{ request()->is('*reports*') ? ' active' : '' }}">
                    <a href="{{ url('reports') }}" class="dash-link "><span class="dash-micon"><i class="mdi mdi-file-document"></i></span><span class="dash-mtext">{{ __('Reports') }}</span></a>
                </li>
