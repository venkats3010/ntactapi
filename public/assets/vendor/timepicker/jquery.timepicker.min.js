...
!(function (a) {
            ...
            for (var d = b.disableTimeRanges.length - 1; d > 0; d--)
                b.disableTimeRanges[d][0] <= b.disableTimeRanges[d - 1][1] &&
                    ((b.disableTimeRanges[d - 1] = [
                        Math.min(
                            b.disableTimeRanges[d][0],
                            b.disableTimeRanges[d - 1][0]
                        ),
                        Math.max(
                            b.disableTimeRanges[d][1],
                            b.disableTimeRanges[d - 1][1]
                        ),
                    ]),
    ...
    function d(b) {
        ...
        if (
            ...
            (d = a("<select />", { class: "ui-timepicker-select" })),
                b.attr("name") &&
                    d.attr("name", "ui-timepicker-" + b.attr("name"));
            var g = d;
        } else {
        ...
        for (var i = n, A = 0; i <= o; A++, i += 60 * z(A)) {
            ...
            if (c.useSelect) {
                ...
                var D = a("<li />");
                D.addClass(
                    B % v < v / 2 ? "ui-timepicker-am" : "ui-timepicker-pm"
                ),
                    D.data("time", u(B, c)),
                    D.text(C);
            }
            if (
                (null !== c.minTime || null !== c.durationTime) &&
                c.showDuration
            ) {
                var E = r(i - l, c.step);
        ...
        if (null !== d) {
            ...
            if (e) {
                ...
                (f + e.outerHeight() > b.outerHeight() || f < 0) &&
                    b.scrollTop(
                        b.scrollTop() + e.position().top - e.outerHeight()
                    ),
        ...
        return a.data("ui-timepicker-value") != b
            ? (a.data("ui-timepicker-value", b),
              "select" == c
                  ...
                  : ["error", "initial"].indexOf(c) == -1 &&
                    a.trigger("changeTime"),
              !0)
            : (["error", "initial"].indexOf(c) == -1 && a.trigger("selectTime"),
              !1);
    }
    function n(a) {
        switch (a.keyCode) {
                ...
                return (
                    ...
                    0 === f.length
                        ...
                        : f.is(":last-child") ||
                          ...
                          f.next().position().top + 2 * f.outerHeight() >
                              e.outerHeight() &&
                              e.scrollTop(e.scrollTop() + f.outerHeight())),
                    !1
                );
    ...
    function q(a) {
        ...
        return (
            !e.hasClass("ui-timepicker-disabled") &&
        ...
        y = {
            ...
            show: function (c) {
                ...
                if (
                    ...
                    ((k &&
                        0 !== k.length &&
                        "function" != typeof f.durationTime) ||
                    ...
                    if (
                        ...
                        var q =
                            k.scrollTop() + o.position().top - o.outerHeight();
                        k.scrollTop(q);
                    } else k.scrollTop(0);
                    return (
                        ...
                        f.closeOnWindowScroll &&
                            a(document).on("scroll.ui-timepicker", g),
            ...
            setTime: function (a) {
                ...
                return (
                    ...
                    b.data("timepicker-list") &&
                        j(b, b.data("timepicker-list")),
                    this
                );
            },
            remove: function () {
