...
<head>
    ...
    <title>NTACT Operations</title>

    <link rel="apple-touch-icon" href="{{ my_asset('assets/images/favicon.jpg')}}">
    <link rel="shortcut icon" href="{{ my_asset('assets/images/favicon.jpg')}}">
    <link rel="icon" href="{{ my_asset('assets/images/favicon.jpg')}}" type="image">
    <!-- GET SERVER NAME -->
    <?php
    ...
    <link rel="stylesheet" type="text/css" href="{{ my_asset('/assets/css/dataTable-style.css') }}">
    <!-- END: STYLESHEETS -->
...
<body class="theme-4">
    <div id="loader" class="loader" style="z-index:99999999999;display:none">
        <div class="double-ring-loader"></div>
    </div>
    <?php if(session('auth')){ ?>
    ...
    <footer class="site-footer text-center my-3 fixed-bottom">&copy; <strong>Brainymed</strong> {{ date('Y') }} All rights
        reserved.
    </footer> 
	...
	<script src="{{ my_asset('assets/js/plugins/simple-datatables.js') }}"></script>
    ...
    <!--<script src="{{ my_asset('/assets/js/ckeditor/ckeditor.js') }}"></script>-->
