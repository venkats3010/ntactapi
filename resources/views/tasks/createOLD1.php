            ...
            <div class="card-body p-0">
                <form role="form" id="create-task" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                <label class="form-label col-md-3">{{ __('Assigned to Multiple') }}</label>
                                <div class="form-group row align-items-center">
                                <div class="col-md-10 multiSelect">
                                <select class="form-control" name="assignedto" id="assignedto" multiple required>
                                    <option value="">Select Priority</option>
...
$(document).ready(function() {
    ...
    .on('change', function() {
        ...
        // Update the content based on selected browsers
        if (selected && selected.length > 0) {
            $('#content').html('<h2>Selected Browsers:</h2><p>' + selected.join(', ') + '</p>');
        } else {
            $('#content').html('<h2>Selected Browsers:</h2><p>No browsers selected.</p>');
        }
    });
});
</script>