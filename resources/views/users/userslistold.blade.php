            ...
            <table class="table dataTable equal-space-table-user" data-plugin="dataTable" id="tblusers">
                ...
                <tbody>
                    ...
                    <tr class="txt-14 thickest">
                        ...
                        <td>
                            @if ($data->status == 'A')
                                <span class="btn btn-block thickest btn-green">Active</span>
                            @else
                                <span class="btn btn-block thickest btn-brown">Inactive</span>
                            @endif
                        </td>
                        <td class="text-end">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="addUID" name="addUID" placeholder="User Id" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="addEmail" name="addEmail" placeholder="Email" required onkeyup="isEmailCheck(this.value)" onchange="isEmail(this.value)">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="phone" class="form-control" id="addPhone" name="addPhone" placeholder="Phone" required>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editFName" name="editFName" placeholder="First Name" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="eidtUID" name="eidtUID" placeholder="User Id" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editEmail" name="editEmail" placeholder="Email" required onkeyup="isEmailCheckEdit(this.value)" onchange="isEmailEdit(this.value)">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editPhone" name="editPhone" placeholder="Phone" required>
...
<script>
    ...
    $('#editUserDetails').click(function() {
        ...
        if (!(filter.test(u_phone))) {
            document.getElementById("emobile").innerHTML = " Please enter number";
            return false;
        }
