...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('users.create', compact('response', 'modules', 'roles'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('users.edit', compact('response', 'modules', 'roles', 'user'));
    }
    ...
    public function profileedit($page)
    {
        ...
        return view('users.profile', compact('response', 'user', 'page'));
    }
